...
This project is indexed by GitNexus as **RimChat** (4885 symbols, 13466 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
