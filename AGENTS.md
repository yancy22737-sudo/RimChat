...
This project is indexed by GitNexus as **RimChat** (7594 symbols, 21830 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
