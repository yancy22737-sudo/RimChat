...
This project is indexed by GitNexus as **RimChat** (9711 symbols, 77845 relationships, 814 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
