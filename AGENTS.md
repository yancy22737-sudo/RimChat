...
This project is indexed by GitNexus as **RimChat** (252 symbols, 224 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
