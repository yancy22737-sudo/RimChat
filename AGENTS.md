...
This project is indexed by GitNexus as **RimChat** (5770 symbols, 16215 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
