...
This project is indexed by GitNexus as **RimChat** (5809 symbols, 16212 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
