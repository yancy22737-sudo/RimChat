...
This project is indexed by GitNexus as **RimChat** (7391 symbols, 21201 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
