...
This project is indexed by GitNexus as **RimChat** (4100 symbols, 11264 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
