...
This project is indexed by GitNexus as **RimChat** (3834 symbols, 10576 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
