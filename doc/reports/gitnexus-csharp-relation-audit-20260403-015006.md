...
- Global STEP_IN_PROCESS edges: 2156
...
- [FAIL] Process zero sample count: value=6 (threshold<=2)
- [FAIL] Global STEP_IN_PROCESS edges: value=2156 (threshold>=2201)
...
| S7 | RimChat/Prompting/ScribanPromptEngine.cs::RenderOrThrow | RimChat/Prompting/PromptTemplateBlockRegistry.cs::TryGetReason | 1 | 1 | 0 | 7 | SAME_NAMESPACE_NO_IMPORT_EDGE |
