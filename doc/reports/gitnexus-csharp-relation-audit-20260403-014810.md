...
- Process zero coverage: 8
- Global STEP_IN_PROCESS edges: 1286
...
- [FAIL] Process zero sample count: value=8 (threshold<=2)
- [FAIL] Global STEP_IN_PROCESS edges: value=1286 (threshold>=2201)
...
| S8 | RimChat/DiplomacySystem/ThingDefResolver.cs::BuildMatchRequest | RimChat/DiplomacySystem/ThingDefMatchEngine.cs::ExtractSemanticTokens | 1 | 1 | 0 | 0 | SAME_NAMESPACE_NO_IMPORT_EDGE |
