...
{
    /// <summary>/// LLMrelationresponseparser
 /// 负责解析AI返回的结构化JSON, 提取relationvalues变化
 ///</summary>
    public class LLMRelationResponse
    {
        /// <summary>/// dialoguecontents (纯text部分)
 ///</summary>
 ...
 ///</summary>
        ...
        /// <summary>/// 单次变化最小限制 (防止微小变化)
 ///</summary>
        public const float MinSignificantDelta = 0.5f;

        /// <summary>/// 解析LLMresponsetext
 ///</summary>
        ...
        /// <summary>/// 从response中提取JSONcontents
 ///</summary>
 ...
 ///</summary>
        ...
        /// <summary>/// 提取dialoguecontents (JSON之前的部分)
 ///</summary>
 ...
 ///</summary>
        ...
        /// <summary>/// apply解析result到relationvalues对象
 ///</summary>
 ...
 ///</summary>
    ...
    /// <summary>/// relationresponse解析resultevent参数
 ///</summary>
