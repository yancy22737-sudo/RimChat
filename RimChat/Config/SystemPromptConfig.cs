 ...
 ///</summary>
        private void InitializeMinimalDefaults()
        {
            ...
            ApiActions = new List<ApiActionConfig>
            {
                ...
                new ApiActionConfig("request_raid_call_everyone", PromptTextConstants.RequestRaidCallEveryoneActionDescription, "", "Global cooldown: 15 days. Use when player continues to provoke after a raid, or when player explicitly requests it."),
                new ApiActionConfig("request_raid_waves", PromptTextConstants.RequestRaidWavesActionDescription, PromptTextConstants.RequestRaidWavesActionParameters, "Faction cooldown: 5 days. Use when call_everyone conditions are met but call_everyone is on cooldown, or when player explicitly requests it."),
