...
namespace RimDiplomacy.NpcDialogue
{
    /// <summary>
    ...
    public class GameComponent_NpcDialoguePushManager : GameComponent
    {
        ...
        private void StartGeneration(NpcDialogueTriggerContext context)
        {
            ...
            if (!AIChatServiceAsync.Instance.IsConfigured())
            {
                Log.Warning($"[RimDiplomacy] Proactive push dropped (AI not configured): {context.Faction.Name}");
                return;
            }
        ...
        private void OnGenerationSuccess(string requestId, string response)
        {
            ...
            {
                Log.Warning("[RimDiplomacy] Proactive push generation empty after sanitize.");
                return;
            }
        ...
        private void OnGenerationError(string requestId, string error)
        {
            ...
            Log.Warning($"[RimDiplomacy] Proactive push dropped after retry: {error}");
        }
        ...
        private TaggedString GetLetterTitle(NpcDialogueTriggerContext context)
        {
            ...
            {
                NpcDialogueCategory.DiplomacyTask => "RimDiplomacy_NpcPush_TitleTask",
                NpcDialogueCategory.WarningThreat => "RimDiplomacy_NpcPush_TitleWarning",
                _ => "RimDiplomacy_NpcPush_TitleSocial"
            };
