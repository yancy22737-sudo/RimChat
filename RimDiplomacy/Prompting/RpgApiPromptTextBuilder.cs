...
namespace RimDiplomacy.Prompting
{
    /// <summary>
    ...
    internal static class RpgApiPromptTextBuilder
    {
        private static readonly string[] SharedActionLines =
        {
            ...
            "- Recruit: Immediately join the player's faction (no parameters). Use only when you have strong intention to join.",
        ...
        public static void AppendActionDefinitions(StringBuilder sb)
        {
            ...
            sb.AppendLine();
            sb.AppendLine($"- TryGainMemory: Add a thought memory to yourself. Use when you want to express a thought or emotion. Required 'defName'. Valid examples: {BuildTryGainMemoryExamples()}.");
