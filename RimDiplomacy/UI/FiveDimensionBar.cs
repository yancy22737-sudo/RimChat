...
namespace RimDiplomacy.UI
{
    ...
    public class FiveDimensionBar
    {
        ...
        public FiveDimensionBar()
        {
            dimensions = new[]
            {
                new DimensionInfo(RelationDimension.Trust, "RimDiplomacy_Trust"),
                new DimensionInfo(RelationDimension.Intimacy, "RimDiplomacy_Intimacy"),
                new DimensionInfo(RelationDimension.Reciprocity, "RimDiplomacy_Reciprocity"),
                new DimensionInfo(RelationDimension.Respect, "RimDiplomacy_Respect"),
                new DimensionInfo(RelationDimension.Influence, "RimDiplomacy_Influence")
            };
        ...
        private void DrawTitleWithCollapseButton(Rect rect)
        {
            ...
            Widgets.Label(labelRect, "RimDiplomacy_FiveDimensionsTitle".Translate());
            GUI.color = Color.white;
        }
