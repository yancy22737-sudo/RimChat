...
namespace RimDiplomacy.UI
{
    ...
    public partial class Dialog_DiplomacyDialogue
    {
        ...
        private float DrawDialogueMainTabs(Rect rect)
        {
            ...
            DrawDialogueMainTabButton(chatRect, "RimDiplomacy_DialogueMainTabChat".Translate(), currentMainTab == DialogueMainTab.Chat, DialogueMainTab.Chat);
        ...
        private void DrawSocialToolbar(Rect rect, GameComponent_DiplomacyManager manager)
        {
            ...
            DrawSocialFilterButton(allRect, "RimDiplomacy_SocialFilterAll".Translate(), !socialCategoryFilter.HasValue, null);
            DrawSocialFilterButton(militaryRect, "RimDiplomacy_NewsCategoryMilitary".Translate(), socialCategoryFilter == SocialPostCategory.Military, SocialPostCategory.Military);
            DrawSocialFilterButton(ecoRect, "RimDiplomacy_NewsCategoryEconomic".Translate(), socialCategoryFilter == SocialPostCategory.Economic, SocialPostCategory.Economic);
            DrawSocialFilterButton(dipRect, "RimDiplomacy_NewsCategoryDiplomatic".Translate(), socialCategoryFilter == SocialPostCategory.Diplomatic, SocialPostCategory.Diplomatic);
            DrawSocialFilterButton(anomalyRect, "RimDiplomacy_NewsCategoryAnomaly".Translate(), socialCategoryFilter == SocialPostCategory.Anomaly, SocialPostCategory.Anomaly);
        ...
        private void DrawSocialPostCard(Rect rect, PublicSocialPost post, GameComponent_DiplomacyManager manager)
        {
            ...
            string likesText = "RimDiplomacy_SocialLikeCount".Translate(post.CurrentLikeCount);

            Rect headerRect = new Rect(rect.x + 10f, rect.y + 6f, rect.width - 20f, 20f);
            GUI.color = new Color(0.75f, 0.8f, 0.86f);
            Widgets.Label(headerRect, "RimDiplomacy_SocialPostHeaderEnhanced".Translate(sourceName, targetName, categoryLabel, credibility));
        ...
        private void DrawLikeButton(Rect rect, PublicSocialPost post, GameComponent_DiplomacyManager manager, Color accent)
        {
            if (post.LikedByPlayer)
            {
                ...
                Widgets.Label(rect, "RimDiplomacy_SocialLikedTag".Translate());
                Text.Anchor = TextAnchor.UpperLeft;
                GUI.color = Color.white;
                return;
            }

            if (!Widgets.ButtonText(rect, "RimDiplomacy_SocialLikeButton".Translate()))
            {
                return;
            }
            ...
            if (!success)
            {
                PushSocialToast("RimDiplomacy_SocialLikeAlready".Translate());
                return;
            }

            string text = goodwillBonus > 0
                ? "RimDiplomacy_SocialLikeReward".Translate(goodwillBonus)
                : "RimDiplomacy_SocialLikeNoReward".Translate();
