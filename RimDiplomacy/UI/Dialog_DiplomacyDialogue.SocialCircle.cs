...
namespace RimDiplomacy.UI
{
    ...
    public partial class Dialog_DiplomacyDialogue
    {
        private bool TryHandleSocialCircleAction(AIAction action, FactionDialogueSession currentSession, Faction currentFaction)
        {
            ...
            if (!(RimDiplomacy.Core.RimDiplomacyMod.Instance?.InstanceSettings?.EnablePlayerInfluenceNews ?? true))
            {
                currentSession?.AddMessage("System", "RimDiplomacy_SocialActionBlocked".Translate(), false, DialogueMessageType.System);
                return true;
            }
            ...
            string systemMessage = ok
                ? "RimDiplomacy_SocialActionPublished".Translate()
                : "RimDiplomacy_SocialActionFailed".Translate();
            ...
            FactionDialogueSession currentSession)
        {
            ...
            if (!(RimDiplomacy.Core.RimDiplomacyMod.Instance?.InstanceSettings?.EnablePlayerInfluenceNews ?? true)) return;
            ...
            if (created)
            {
                currentSession?.AddMessage("System", "RimDiplomacy_SocialActionKeywordCreated".Translate(), false, DialogueMessageType.System);
            }
        }
