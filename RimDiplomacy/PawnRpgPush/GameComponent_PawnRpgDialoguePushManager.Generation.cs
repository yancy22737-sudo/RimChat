...
namespace RimDiplomacy.PawnRpgPush
{
    ...
    public partial class GameComponent_PawnRpgDialoguePushManager
    {
        private void StartGeneration(PawnRpgTriggerContext context, Pawn npcPawn, Pawn playerPawn)
        {
            ...
            {
                Log.Warning($"[RimDiplomacy] PawnRPG proactive dropped (AI not configured): {context.Faction?.Name ?? "Unknown"}");
                return;
            }
        ...
        private void OnGenerationSuccess(string requestId, string response)
        {
            ...
            {
                Log.Warning("[RimDiplomacy] PawnRPG proactive generation empty after sanitize.");
                return;
            }
        ...
        private void OnGenerationError(string requestId, string error)
        {
            ...
            Log.Warning($"[RimDiplomacy] PawnRPG proactive dropped after retry: {error}");
        }
        ...
        private TaggedString GetLetterTitle(PawnRpgTriggerContext context, Pawn npcPawn, Pawn playerPawn)
        {
            ...
            {
                NpcDialogueCategory.DiplomacyTask => "RimDiplomacy_PawnRpgPush_TitleTask",
                NpcDialogueCategory.WarningThreat => "RimDiplomacy_PawnRpgPush_TitleWarning",
                _ => "RimDiplomacy_PawnRpgPush_TitleSocial"
            };
