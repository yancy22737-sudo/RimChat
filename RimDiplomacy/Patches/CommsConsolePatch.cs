...
namespace RimDiplomacy.Patches
{
    ...
    public static class CommsConsolePatch
    {
        ...
        public static void Initialize(Harmony harmony)
        {
            try
            {
                Log.Message("[RimDiplomacy] === Initializing CommsConsole Patch ===");
                ...
                {
                    Log.Warning("[RimDiplomacy] Could not find Building_CommsConsole type");
                    return;
                }

                Log.Message($"[RimDiplomacy] Found Building_CommsConsole: {commsConsoleType.FullName}");
                Log.Message("[RimDiplomacy] Building_CommsConsole methods:");
                ...
                {
                    Log.Message($"[RimDiplomacy] Found CompUsable: {compUsableType.FullName}");
                    Log.Message("[RimDiplomacy] CompUsable methods:");
                ...
                {
                    Log.Message($"[RimDiplomacy] Found JobDriver_UseCommsConsole: {jobDriverType.FullName}");
                    Log.Message("[RimDiplomacy] JobDriver_UseCommsConsole methods:");
            ...
            {
                Log.Error($"[RimDiplomacy] Error initializing patch: {ex}");
            }
        }
        ...
        private static void PatchCommsConsoleMethods(Harmony harmony, Type commsConsoleType)
        {
            ...
            {
                Log.Message($"[RimDiplomacy] Patching Building_CommsConsole.GetFloatMenuOptions method");
        ...
        {
            if (!RimDiplomacyMod.Instance?.InstanceSettings?.ReplaceCommsConsole ?? false)
            {
