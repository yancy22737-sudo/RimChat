        ...
        public ActionValidationResult ValidateActionExecution(Faction faction, string actionType, Dictionary<string, object> parameters)
        {
            ...
            switch (actionType)
            {
                case "request_aid":
                    ...
                    {
                        int minGoodwill = RimDiplomacyMod.Instance?.InstanceSettings?.MinGoodwillForAid ?? 0;
                ...
                case "declare_war":
                    ...
                    {
                        int maxGoodwill = RimDiplomacyMod.Instance?.InstanceSettings?.MaxGoodwillForWarDeclaration ?? 0;
