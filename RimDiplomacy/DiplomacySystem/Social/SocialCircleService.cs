...
{
    /// <summary>
    /// Dependencies: RimWorld factions/goodwill/incident/world-settlement APIs, RimDiplomacy settings.
    ...
    public static class SocialCircleService
    {
        ...
        public static int CalculateNextIntervalTicks(RimDiplomacySettings settings)
        {
            ...
            string intentHint)
        {
            ...
            Log.Message($"[RimDiplomacy] Social post created ({reason}) impact={post.ImpactType}: {post.Content}");
            return post;
        }
        ...
        public static string GetCategoryLabelKey(SocialPostCategory category)
        {
            switch (category)
            {
                case SocialPostCategory.Military:
                    return "RimDiplomacy_NewsCategoryMilitary";
                case SocialPostCategory.Economic:
                    return "RimDiplomacy_NewsCategoryEconomic";
                case SocialPostCategory.Anomaly:
                    return "RimDiplomacy_NewsCategoryAnomaly";
                default:
                    return "RimDiplomacy_NewsCategoryDiplomatic";
            }
        }

        private static string BuildPostContent(PublicSocialPost post, string summary)
        {
            string sourceName = post.SourceFaction?.Name ?? "RimDiplomacy_Unknown".Translate().ToString();
            string targetName = post.TargetFaction?.Name ?? "RimDiplomacy_SocialNoTarget".Translate().ToString();
            string sourceLeader = string.IsNullOrEmpty(post.SourceLeaderName)
                ? "RimDiplomacy_SocialNoLeader".Translate().ToString()
            ...
            {
                return "RimDiplomacy_SocialPostTemplateSummaryLeader".Translate(
                    summary.Trim(),
                    sourceName,
                    sourceLeader,
                    targetName,
            ...
            if (post.Sentiment > 0)
            {
                return "RimDiplomacy_SocialPostTemplatePositiveLeader".Translate(
                    sourceName,
                    sourceLeader,
                    targetName,
                    targetLeader,
            ...
            if (post.Sentiment < 0)
            {
                return "RimDiplomacy_SocialPostTemplateNegativeLeader".Translate(
                    sourceName,
                    sourceLeader,
                    targetName,
                    targetLeader,
            ...
            return "RimDiplomacy_SocialPostTemplateNeutralLeader".Translate(
                sourceName,
                sourceLeader,
                targetName,
                targetLeader,
        ...
        private static string BuildPlannedEffectSummary(PublicSocialPost post)
        {
            ...
            return "RimDiplomacy_SocialEffectSummaryComposite".Translate(goodwillText, impactText);
        }
        ...
        private static string GetImpactNarrative(SocialPostImpactType impactType)
        {
            switch (impactType)
            {
                case SocialPostImpactType.SettlementGain:
                    return "RimDiplomacy_SocialImpactNarrativeSettlementGain".Translate();
                case SocialPostImpactType.SettlementLoss:
                    return "RimDiplomacy_SocialImpactNarrativeSettlementLoss".Translate();
                case SocialPostImpactType.IncidentColdSnap:
                    return "RimDiplomacy_SocialImpactNarrativeColdSnap".Translate();
                case SocialPostImpactType.IncidentBlight:
                    return "RimDiplomacy_SocialImpactNarrativeBlight".Translate();
                default:
                    return "RimDiplomacy_SocialImpactNarrativeGoodwill".Translate();
            }
        }
        ...
        private static string GetImpactResultText(SocialPostImpactType impactType, bool success)
        {
            ...
            {
                return "RimDiplomacy_SocialImpactResultSkipped".Translate();
            }

            switch (impactType)
            {
                case SocialPostImpactType.SettlementGain:
                    return "RimDiplomacy_SocialImpactResultSettlementGain".Translate();
                case SocialPostImpactType.SettlementLoss:
                    return "RimDiplomacy_SocialImpactResultSettlementLoss".Translate();
                case SocialPostImpactType.IncidentColdSnap:
                    return "RimDiplomacy_SocialImpactResultColdSnap".Translate();
                case SocialPostImpactType.IncidentBlight:
                    return "RimDiplomacy_SocialImpactResultBlight".Translate();
                default:
                    return "RimDiplomacy_SocialImpactResultGoodwill".Translate();
            }
        }
