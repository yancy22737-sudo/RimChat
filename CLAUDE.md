...
This project is indexed by GitNexus as **RimChat** (6022 symbols, 16872 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
