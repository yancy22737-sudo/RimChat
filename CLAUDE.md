...
This project is indexed by GitNexus as **RimChat** (7752 symbols, 22202 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
