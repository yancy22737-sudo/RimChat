...
This project is indexed by GitNexus as **RimChat** (5927 symbols, 16627 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
