...
This project is indexed by GitNexus as **RimChat** (5984 symbols, 16772 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
