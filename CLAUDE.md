...
This project is indexed by GitNexus as **RimChat** (6818 symbols, 19681 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
